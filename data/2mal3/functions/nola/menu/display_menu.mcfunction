...
tellraw @s [{"text":"No Lag Datapack v2.4.1","bold":true,"color":"gold"},{"text":"\n------------------------\n","color":"gold"}]
...
tellraw @s {"text":"\u231a Check for updates","color":"gold","clickEvent":{"action":"open_url","value":"https://github.com/2mal3/core/wiki/No-Lag-Update-Check-v2.4.1"},"hoverEvent":{"action":"show_text","contents":"*open link*"}}
