...
tellraw @s [{"text":"[\u270e]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.entity_limiter.max_passive nola.config "},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Maximum passive entitys together: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Maximum number of passive entities that can stand next to each other."}},{"score":{"name":"$nola.entity_limiter.max_passive","objective":"nola.config"},"color":"red"}]
tellraw @s [{"text":"[\u270e]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.entity_limiter.max_neutral nola.config "},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Maximum neutral entitys together: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Maximum number of neutral entities that can stand next to each other."}},{"score":{"name":"$nola.entity_limiter.max_neutral","objective":"nola.config"},"color":"red"}]
tellraw @s [{"text":"[\u270e]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.entity_limiter.max_hostile nola.config "},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Maximum hostile entitys together: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Maximum number of hostile entities that can stand next to each other."}},{"score":{"name":"$nola.entity_limiter.max_hostile","objective":"nola.config"},"color":"red"}]
