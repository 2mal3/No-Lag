...
tellraw @s [{"text":"[\u270e]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.item_despawn_time nola.config "},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Item despawn time: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Time after items are deleted in minutes (max. 5)."}},{"score":{"name":"$nola.item_despawn_time","objective":"nola.config"},"color":"red"}]
...
tellraw @s [{"text":"[\u270e]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.lag_clear_time nola.config "},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Lag clear time: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Time interval in which a lag clear is executed (in minutes)."}},{"score":{"name":"$nola.lag_clear_time","objective":"nola.config"},"color":"red"}]
