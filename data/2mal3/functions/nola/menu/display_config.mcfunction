...
tellraw @s [{"text":"Maximum entiys on one block:","color":"gold","clickEvent":{"action":"suggest_command","value":"/gamerule maxEntityCramming "},"hoverEvent":{"action":"show_text","contents":"How many entities can stand on a block before one gets damaged?"}},{"text":" ","color":"gold"},{"score":{"name":"$nola.max_entity_cramming","objective":"nola.data"},"color":"red"}]
...
tellraw @s [{"text":"Item despawn time: ","color":"gold","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.item_despawn_time nola.config "},"hoverEvent":{"action":"show_text","contents":"Time after items are deleted in minutes (max. 5)."}},{"score":{"name":"$nola.item_despawn_time","objective":"nola.config"},"color":"red"}]
...
tellraw @s [{"text":"Lag clear time: ","color":"gold","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.lag_clear_time nola.config "},"hoverEvent":{"action":"show_text","contents":"Time interval in which a lag clear is executed (in minutes)."}},{"score":{"name":"$nola.lag_clear_time","objective":"nola.config"},"color":"red","hoverEvent":{"action":"show_text","contents":""}}]
