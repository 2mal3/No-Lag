...
tellraw @s [{"text":"Maximum entiys on one block:","color":"gold","clickEvent":{"action":"suggest_command","value":"/gamerule maxEntityCramming <number>"},"hoverEvent":{"action":"show_text","contents":"How many entities can stand on a block before one gets damaged?"}},{"text":" ","color":"gold"},{"score":{"name":"$nola.max_entity_cramming","objective":"nola.data"},"color":"red"}]

tellraw @s {"text":""}

# Displays config for custom item despan
execute if score $nola.item_despawn nola.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/item_despawn/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Custom item despawn","color":"gold","hoverEvent":{"action":"show_text","contents":"Items are deleted after a specified time."}}]
execute if score $nola.item_despawn nola.config matches 1 run tellraw @s [{"text":"[\u2714]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/item_despawn/false"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Custom item despawn","color":"gold","hoverEvent":{"action":"show_text","contents":"Items are deleted after a specified time."}}]
tellraw @s [{"text":"Item despawn time: ","color":"gold","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.item_despawn_time nola.config <number>"},"hoverEvent":{"action":"show_text","contents":"Time after items are deleted in minutes (max. 5)."}},{"score":{"name":"$nola.item_despawn_time","objective":"nola.config"},"color":"red"}]

tellraw @s {"text":""}

# Displays config for no ai
execute if score $nola.no_ai nola.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/no_ai/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" "},{"text":"Entity freezing","color":"gold","hoverEvent":{"action":"show_text","contents":"Freezes all set entities if they are outside a certain distance."}}]
execute if score $nola.no_ai nola.config matches 1 run tellraw @s [{"text":"[\u2714]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/no_ai/false"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" "},{"text":"Entity freezing","color":"gold","hoverEvent":{"action":"show_text","contents":"Freezes all set entities if they are outside a certain distance."}}]
execute if score $nola.no_ai_distance nola.config matches 35 run tellraw @s [{"text":"Freezing distance: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Distance from which entities are frozen."}},{"text":"[35]","color":"red","hoverEvent":{"action":"show_text","contents":""}},{"text":" ","color":"gold"},{"text":"[64]","color":"gray","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/freezing_distance/64"},"hoverEvent":{"action":"show_text","contents":"*click*"}}]
execute if score $nola.no_ai_distance nola.config matches 64 run tellraw @s [{"text":"Freezing distance: ","color":"gold","hoverEvent":{"action":"show_text","contents":"Distance from which entities are frozen."}},{"text":"[35]","color":"gray","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/freezing_distance/35"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" [64]","color":"red","hoverEvent":{"action":"show_text","contents":""}}]

tellraw @s {"text":""}

# Displays config for xp merge
execute if score $nola.xp_merge nola.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/xp_merge/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Merge xp orbs","color":"gold","hoverEvent":{"action":"show_text","contents":"Xp Orbs will be merged (this may affect the Mendig enchantment)."}}]
execute if score $nola.xp_merge nola.config matches 1 run tellraw @s [{"text":"[\u2714]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/xp_merge/false"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Merge xp orbs","color":"gold","hoverEvent":{"action":"show_text","contents":"Xp Orbs will be merged (this may affect the Mendig enchantment)."}}]

tellraw @s {"text":""}

# Displays config for lag clear
execute if score $nola.lag_clear nola.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/lag_clear/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Lag clear","color":"gold","hoverEvent":{"action":"show_text","contents":"Deletes all unused entitys in set time intervals."}}]
execute if score $nola.lag_clear nola.config matches 1 run tellraw @s [{"text":"[\u2714]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/lag_clear/false"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Lag clear","color":"gold","hoverEvent":{"action":"show_text","contents":"Deletes all unused entitys in set time intervals."}}]
tellraw @s [{"text":"Lag clear time: ","color":"gold","clickEvent":{"action":"suggest_command","value":"/scoreboard players set $nola.lag_clear_time nola.config <time>"},"hoverEvent":{"action":"show_text","contents":"Time interval in which a lag clear is executed (in minutes)."}},{"score":{"name":"$nola.lag_clear_time","objective":"nola.config"},"color":"red","hoverEvent":{"action":"show_text","contents":""}}]
execute if score $nola.lag_clear_not_at_night nola.config matches 0 run tellraw @s [{"text":"[\u274c]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/lag_clear_not_at_night/true"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Lag clear not at night","color":"gold","hoverEvent":{"action":"show_text","contents":"The Lag Clear is deactivated overnight."}}]
execute if score $nola.lag_clear_not_at_night nola.config matches 1 run tellraw @s [{"text":"[\u2714]","color":"dark_green","clickEvent":{"action":"run_command","value":"/function 2mal3:nola/menu/buttons/lag_clear_not_at_night/false"},"hoverEvent":{"action":"show_text","contents":"*click*"}},{"text":" Lag clear not at night","color":"gold","hoverEvent":{"action":"show_text","contents":"The Lag Clear is deactivated overnight."}}]
