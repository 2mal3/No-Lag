...
execute as @e[type=minecraft:experience_orb] at @s if entity @e[type=minecraft:experience_orb,distance=0.001..2] run function 2mal3:nola/modules/xp_merge/test
