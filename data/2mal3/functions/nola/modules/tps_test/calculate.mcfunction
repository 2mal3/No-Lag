...
tellraw @a[scores={nola.debug_mode=3..}] [{"text":"[","color":"gray"},{"text":"NoLag","color":"green"},{"text":"/","color":"gray"},{"text":"INFO","color":"green"},{"text":"]: ","color":"gray"},{"text":"TPS tested! In the last 5 minutes the tps was at ~","color":"green"},{"score":{"name":".tps_0","objective":"nola.data"},"color":"gray"},{"text":" (countetd ","color":"green"},{"score":{"name":".temp_0","objective":"nola.data"},"color":"gray"},{"text":" ticks)","color":"green"}]
