...
execute as @e[tag=!nola.no_ai,tag=!nola.ignore,type=!minecraft:villager,team=!this_team_does_not_exist] at @s unless entity @p[distance=..35,gamemode=!spectator] run function 2mal3:nola/modules/no_ai/enable
