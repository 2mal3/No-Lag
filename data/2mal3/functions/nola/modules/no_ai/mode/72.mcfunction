...
execute as @e[type=!#2mal3:nola/ignore,tag=nola.no_ai,tag=!nola.ignore] at @s if entity @p[distance=..72,gamemode=!spectator] run function 2mal3:nola/modules/no_ai/disable