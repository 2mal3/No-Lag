...
execute as @e[type=!#2mal3:nola/ignore,tag=!nola.no_ai,tag=!nola.ignore,type=!minecraft:villager] if data entity @s Attributes at @s unless entity @p[distance=..72,gamemode=!spectator] run function 2mal3:nola/modules/no_ai/enable
