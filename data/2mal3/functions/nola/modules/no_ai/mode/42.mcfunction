...
execute as @e[tag=!nola.no_ai,tag=!nola.ignore,type=!minecraft:villager] at @s unless entity @p[distance=..42,gamemode=!spectator] if data entity @s Attributes run function 2mal3:nola/modules/no_ai/enable
