...
# Send remove message
tellraw @a [{"text":"No Lag Datapack v2.4.2 by 2mal3 was successfully uninstalled."}]
...
datapack disable "file/No-Lag-Datapack-v2.4.2"
datapack disable "file/No-Lag-Datapack-v2.4.2.zip"
