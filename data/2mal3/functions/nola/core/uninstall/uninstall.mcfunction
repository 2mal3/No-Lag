...
# Send remove message
tellraw @a [{"text":"No Lag Datapack v2.3.0 by 2mal3 was successfully uninstalled."}]
...
datapack disable "file/No-Lag-Datapack-v2.3.0"
datapack disable "file/No-Lag-Datapack-v2.3.0.zip"
