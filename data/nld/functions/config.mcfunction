...
execute as @e[type=!#nld:ignore,tag=nld.NoAI] at @s if entity @a[distance=..41] run data merge entity @s {NoAI:0b}
execute as @e[type=!#nld:ignore,tag=nld.NoAI] at @s if entity @a[distance=..41] run tag @s remove nld.NoAI
execute as @e[type=!#nld:ignore,tag=!nld.NoAI] at @s unless entity @a[distance=..41] run data merge entity @s {NoAI:1b}
execute as @e[type=!#nld:ignore,tag=!nld.NoAI] at @s unless entity @a[distance=..41] run tag @s add nld.NoAI
#                                                                               A
#                                                                               |
